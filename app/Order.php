...
{
    protected $fillable = ['id', 'user_id', 'address_id', 'bank', 'sender', 'status', 'total_payment', 'photo'];
    ...
    public function refreshTotalPayment()
    {
        ...
        foreach ($this->details as $detail) {
            $total_payment = $detail->total_price + $detail->total_fee;
        }
    ...
    {
        if ($this->photo !=='') {
            return url ('/img/bukti-pembayaran/'. $this->photo);
        }else{
