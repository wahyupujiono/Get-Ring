...
class CheckoutController extends Controller
{
    ...
    protected function saveAddressSession(CheckoutAddressRequest $request)
    {
        session([
            ...
            'checkout.address.name_event' => $request->get('name_event'),
            'checkout.address.detail_event' => $request->get('detail_event'),
            'checkout.address.date_event' => $request->get('date_event')
        ]);
    }
    ...
    protected function setupAddress(User $customer, $addressSession)
    {
        ...
        return Address::create([
            ...
            'name_event' => $addressSession['name_event'],
            'detail_event' => $addressSession['detail_event'],
            'date_event' => $addressSession['date_event']
        ]);
    }
