            ...
            <div class="row">
                ...
                @forelse($products as $product)
                    ...
                    <div class="col-md-12 text-center">
                        @if(isset($q))
                        <h1>:(</h1>
                        <p>Menu Catering yang anda cari tidak ditemukan.</p>
                        @if(isset($category))
                    ...
                    @else
                        <h1>:|</h1>
                        <p>Belum ada menu catering untuk kategori ini.</p>
                        @endif

                        <p><a href="{{url('/catalogs')}}">Lihat Semua Menu Catering <i class="fa fa-arrow-right"></i></p>
                    </div>
                @endforelse
